...
export const saveUser = async (user) => {
  ...
  const res = await fetch("https://contest-hub-server.onrender.com/users", {
    method: "POST",
    headers: {
...
export const getUserByEmail = async (email) => {
  try {
    const data = await secureFetch(`https://contest-hub-server.onrender.com/users/${email}`);
    return data;
  } catch (err) {
...
const API = "https://contest-hub-server.onrender.com";
